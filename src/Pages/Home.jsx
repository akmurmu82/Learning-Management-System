...
function Home() {
  ...
  return (
    <>
      ...
      <Box>
        <Text>Discover more on the MyStudyLife blog</Text>
        <Text>See how MyStudyLife can help organize your life.</Text>
        <VStack>
          <SectionCard />
        </VStack>
      </Box>
